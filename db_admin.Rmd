...
risksxl_path <- "bkps/2020-11-04-risksbkp.xlsx"
actionsxl_path <- "bkps/2020-11-04-actionsbkp.xlsx"
...
dbWriteTable(conn = db_conn,
             append = TRUE,
             name = "risks",
             value = read_xlsx(path = risksxl_path,
                               # sheet = "risks", 
                               na = "")
             )
```
...
dbWriteTable(conn = db_conn,
             append = TRUE,
             name = "actions",
             value = read_xlsx(path = actionsxl_path,
                               # sheet = "actions", 
                               na = "")
             )
```
