...
# tests with Tesla like data
riskdb_path <- "D:/sharpRISK/risks.db"
risks_path <- "support_files/heatmap.xlsx"
heat_conn <- dbConnect(RSQLite::SQLite(), dbname = riskdb_path)

# tests with real data (not public)
# Venus 1
# riskdb_path <- "venus_expert.db"
# heatxl_path <- "support_files/venus_expert_risks.xlsx"
# heat_conn <- dbConnect(RSQLite::SQLite(), dbname = riskdb_path)

# Venus 2
# risks_path <- "bkps/2020-10-04-risksbkp.xlsx"
# actions_path <- "bkps/2020-10-04-actionsbkp.xlsx"
# riskdb_path <- "venus_expert2.db"
# heat_conn <- dbConnect(RSQLite::SQLite(), dbname = riskdb_path)

knitr::opts_chunk$set(connection = "heat_conn")
```
