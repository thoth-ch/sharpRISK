...
# Setting up the connection to the db file to avoid adding it in every chunk:
knitr::opts_chunk$set(connection = "riskdb_conn")

# The code below has to be inserted at the end of the server.R file
# in case the ui becomes  an html file
...
rsconnect::deployApp(
    account = "thoth",
    appFiles = c("ui.R", "server.R", "rpy_prototype.py", "tridel.db",
                 "www/risk_app.css"),
    appName = "sharpRISK",
    upload = TRUE,
    python = "/home/joao/anaconda3/envs/Rpython/bin/python")
...
actions_graph %>%
  ...
  labs(x = "",
       ...
       caption = "Based on J.Silge Tidytext")
```
